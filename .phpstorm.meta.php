...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/vinzy/Documents/Semester 4/Praktik SPK/spk-karir-ti/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Users/vinzy/Documents/Semester 4/Praktik SPK/spk-karir-ti/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'signed','throttle','verified','admin',);
        registerArgumentsSet('routes', 'landing','dashboard','profile.edit','profile.update',
'profile.destroy','mahasiswa.create','mahasiswa.store','penilaian.create','penilaian.store',
'penilaian.calculate','hasil.index','hasil.detail','admin.dashboard','admin.kriteria.index',
'admin.kriteria.create','admin.kriteria.store','admin.kriteria.show','admin.kriteria.edit','admin.kriteria.update',
'admin.kriteria.destroy','admin.alternatif.index','admin.alternatif.create','admin.alternatif.store','admin.alternatif.show',
'admin.alternatif.edit','admin.alternatif.update','admin.alternatif.destroy','register',
...
'admin.alternatif.form','admin.alternatif.index','admin.dashboard','admin.kriteria.form','admin.kriteria.index',
...
'hasil.detail','hasil.index','landing','layouts.app','layouts.guest',
'layouts.navigation','layouts.spk','mahasiswa.create','penilaian.create','profile.edit',
